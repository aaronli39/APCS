...
public class Rational implements Comparable
{
  ...
  *********************/
  public boolean equals( Object other )
  {
    ...
    // If compareTo() returns 0, then the two Rationals are equal
  ...
  *********************/
  public int compareTo( Object other )
  {
    ...
    // If input is a Rational, then subtract their products from cross
    // multiplying, which will be positive if this > other, and negative
    // if this < other. Otherwise 0 is returned.
    if (other instanceof Rational) {
      current = this._numerator * ((Rational) other)._denominator;
      input = this._denominator * ((Rational) other)._numerator;
      return current - input;
    } else {
      // Error message tells user the problem
  ...
  public static void main( String[] args )
  {
    ...
    System.out.println("\nComparing s and y: should produce an error...");
