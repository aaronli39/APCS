// Team Ultimate: Aaron Li, Collin Hosking
// APCS02 pd08
// HW26 -- DeIteratour
// 2018-03-27
...
public class ItrWork
{
     ...
     public static List<Integer> oddsB( List<Integer> L )
     {
          ...
          Iterator<Integer> it = L.iterator(); //MUST typecast as Integer in order to safely use modulo function
          while (it.hasNext()){
               int temp = it.next();
               if (temp % 2 == 1){
                    ans.add(temp);
     ...
     public static void removeEvens( List<Integer> L )
     {
          ...
          while (it.hasNext()){
               int temp = it.next();
               if (temp % 2 == 0){
                    it.remove();     //removes the value when it.next was called
               }
          }
     }
