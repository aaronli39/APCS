...
public class BankAccount
{
	...
	if (withdrawAmount <= balance) {
	    ...
	    System.out.println("* Withdrawal of " + oldbalance + " made. Your new balance is: \n" + balance + "\n");
	    output = true;
	}
	else if (withdrawAmount > balance) {
	    System.out.println("* Withdrawal of " + oldbalance + " unsuccessful. You do not have enough money.\n");
	    output = false;
	}
	return output;
    }
    ...
    // Authentication code.
    public boolean authenticate(String namez, String password) {
	boolean output = true;
	if (name == namez && password == passwd) {
	    System.out.println("* Authentication successful. Input credentials are correct. \n");
	    output = true;
	}
	else if (name != namez || password != passwd) {
	    System.out.println("* Authentication unsuccessful. Either one or both inputted credentials are incorrect. Please enter the correct credentials and try again. \n");
	    output = false;
	}
	return output;
    }
